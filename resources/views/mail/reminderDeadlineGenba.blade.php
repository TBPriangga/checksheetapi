...
<body style="color: black; font-family: Arial, sans-serif;">
    ...
    <p style="font-size: 16px;">
        Penemuan pada area <strong>{{ $data['area']->name }}</strong> pada laporan Genba Management Belum di selesaikan.
    </p>
    ...
    <p style="font-size: 16px;">
        Dimohon untuk segera diselesaikan dengan cepat sebelum melewati batas deadline yang sudah ditetapkan.
    </p>
