...
<div class="wrapper wrapper-content animated fadeInRight">
    <form method="post" action="/genba/penilaian/store" enctype="multipart/form-data">
        @csrf
        <input type="hidden" value={{ $detail_id }} name="genba_detail_id">
            ...
            <div class="ibox-content">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0 mt-3 mt-sm-2">
                        ...
                        <div class="col form-check">
                            <input class="form-check-input" type="radio" name="pertanyaan_1" id="radio_pertanyaan_1" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_1">1</label>
                        </div>
                        <div class="col form-check">
                            <input class="form-check-input" type="radio" name="pertanyaan_1" id="radio2_pertanyaan_1" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_1">2</label>
                        </div>
                        <div class="col form-check">
                            <input class="form-check-input" type="radio" name="pertanyaan_1" id="radio3_pertanyaan_1" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_2" id="radio_pertanyaan_2" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_2">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_2" id="radio2_pertanyaan_2" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_2">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_2" id="radio3_pertanyaan_2" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_3" id="radio_pertanyaan_3" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_3">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_3" id="radio2_pertanyaan_3" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_3">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_3" id="radio3_pertanyaan_3" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_4" id="radio_pertanyaan_4" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_4">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_4" id="radio2_pertanyaan_4" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_4">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_4" id="radio3_pertanyaan_4" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_5" id="radio_pertanyaan_5" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_5">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_5" id="radio2_pertanyaan_5" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_5">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_5" id="radio3_pertanyaan_5" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_6" id="radio_pertanyaan_6" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_6">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_6" id="radio2_pertanyaan_6" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_6">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_6" id="radio3_pertanyaan_6" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_7" id="radio_pertanyaan_7" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_7">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_7" id="radio2_pertanyaan_7" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_7">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_7" id="radio3_pertanyaan_7" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_8" id="radio_pertanyaan_8" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_8">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_8" id="radio2_pertanyaan_8" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_8">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_8" id="radio3_pertanyaan_8" value="3">
                ...
                <div>
                    <label class="col-form-label responsive-text">Area kerja dalam kondisi aman dan bebas dari barang, material peralatan dan mesin yang berpotensi bahaya kecelakaan kerja.(Stom 6 : Terjepit mesin, Kejatuhan benda berat, Tertabrak Kendaraan, Terjatuh dari Ketinggian, Tersengat listrik, Terkena Benda?Mesin Panas, Tergores, Tertusuk, Tersayat, Terbentur, Teperosok, dan Terpeleset).
                        ...
                        <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                            ...
                            <div class="col form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pertanyaan_9" id="radio_pertanyaan_9" value="1">
                                <label class="form-check-label" for="radio_pertanyaan_9">1</label>
                            </div>
                            <div class="col form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pertanyaan_9" id="radio2_pertanyaan_9" value="2">
                                <label class="form-check-label" for="radio2_pertanyaan_9">2</label>
                            </div>
                            <div class="col form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="pertanyaan_9" id="radio3_pertanyaan_9" value="3">
                ...
                <div>
                    ...
                    <div class="row ml-sm-5 ml-0  mt-3 mt-sm-2">
                        ...
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_10" id="radio_pertanyaan_10" value="1">
                            <label class="form-check-label" for="radio_pertanyaan_10">1</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_10" id="radio2_pertanyaan_10" value="2">
                            <label class="form-check-label" for="radio2_pertanyaan_10">2</label>
                        </div>
                        <div class="col form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="pertanyaan_10" id="radio3_pertanyaan_10" value="3">
                ...
                <div class="form-group row">
                    <div class="col-sm-4 col-sm-offset-2">
                        ...
                        <button class="btn btn-primary btn-lg compose_mail" type="submit">Submit Nilai</button>
                    </div>
                </div>
                </div> 
            </div>
