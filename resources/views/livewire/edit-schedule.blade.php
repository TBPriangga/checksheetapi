...
<form method="post" action="/genba/schedule/update" enctype="multipart/form-data">
    ...
    <div class="col-lg-12">
        <div class="ibox ">
            ...
            <div class="ibox-content">
                @livewire('form-area-p-i-c', ['genba_area' => $genba->area_id,])
                @stack('scripts')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4" id="data_schedule">
            <div class="input-group date" >
                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="tanggal_patrol" value="@dateWithDay($genba->tanggal_patrol)">
            </div>
        </div>
            ...
            <div wire:ignore class="col-sm-4">
                <select  class="select2_demo_schedule form-control" name="team_id" required>
                    ...
                    @foreach($teams as $team)
                        <option value={{ $team->id }} @if($team->id == $genba->team_id)selected @endif>{{ $team->name }}</option>
                    @endforeach
                </select>
            </div>
...
<div class="row">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <div><input type="checkbox" name="PIC_auditor" value="{{ $member->user->id }}" onclick="checkedBox(this)" @if($member->user->id == $genba->pic_auditor_id) checked @endif></div>
                </td>
    ...
    <div class="row" style="margin-left:0">
        ...
        <div class="col-lg-2 col-5 m-3 m-sm-0">
            <a href="/genba/schedule/delete/{{ $genba->id }}" class="btn btn-block btn-danger text-white" type="submit">Delete Team</a>
        </div>
        @if($buttonVisible)
        <div class="col-lg-2 col-5 m-3 m-sm-0">
