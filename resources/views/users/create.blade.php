            ...
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="detail_dept_id" name="detail_dept_id" required="required" >
                        <option value="" selected="selected"> -- Select -- </option>
                        @foreach ($detail_departments as $det_dept)
                            <option value="{{ $det_dept->detail_dept_id }}" >{{ $det_dept->name}}</option>
                        @endforeach
                    </select>
                    @if ($errors->has('detail_dept_id'))
                        <span class="text-danger text-left">{{ $errors->first('detail_dept_id') }}</span>
                    @endif
                </div>
