        ...
        <div class="ibox-content">
            ...
            <div class="row mt-2">
                <div id="" class="col-6">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-12">
                                <label for="">Product Study</label>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-success" id="product_study" style="width: 0%" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                ...
                                <div class="progress">
                                    <div class="progress-bar" style="width: 0%" role="progressbar" id="product_design" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="">Tooling Preparation</label>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-warning" style="width: 0%" id="tooling_manufacturing" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="">Homeline Trial</label>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-danger" style="width: 0%" id="homeline_trial" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-12">
                                <label for="">Initial Masspro</label>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-default" style="width: 0%" id="initial_masspro" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row dept_charts" id="dept_charts"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#project_search, #customer_search, #dept_search, #product_search, #milestone_search").change(function(){
        ...
        var check = $.ajax({
                    url: "{{route('project_performance.index')}}",
                    type: "get",
                    data: {
                        _token: '{{csrf_token()}}',
                        project: project,
                    ...
                    success: function (res) {
                        ...
                        var data_delay = JSON.parse(res['data_delay']);console.log(data_delay);

                        var array_per_milestone= [];
                        milestone_all.forEach(milestone => {
                            // console.log(milestone.milestone);
                            // console.log(milestone.count_milestone);
                       ...
                       var persen_initial_masspro =isNaN(array_per_milestone.InitialMasspro_selesai / array_per_milestone.InitialMasspro_all) ? 0:(array_per_milestone.InitialMasspro_selesai / array_per_milestone.InitialMasspro_all)*100;
                        ...
                        //product study Set the width of the progress bar
                            ...
                            $('#product_study').html(persen_product_study.toFixed(1)+"%");
                        //tooling Manufacturing Set the width of the progress bar
                            ...
                            $('#tooling_manufacturing').html(persen_tooling_manufacturing.toFixed(1)+"%");
                        //Product design Set the width of the progress bar
                            ...
                            $('#product_design').html(persen_product_design.toFixed(1)+"%");
                        //Home line trial Set the width of the progress bar 
                            ...
                            $('#homeline_trial').html(persen_homeline_trial.toFixed(1)+"%");
                        //Initial masspro Set the width of the progress bar 
                            $('#initial_masspro').css('width', persen_initial_masspro + '%');
                            $('#initial_masspro').attr('aria-valuenow', persen_initial_masspro);
                            $('#initial_masspro').html(persen_initial_masspro.toFixed(1)+"%");
                        ...
                        // set polar data dept charts
                            ...
                            dept_pic_all.forEach(dept => {
                                    ...
                                    // set qty selesai
                                        ...
                                        dept_pic_selesai.forEach(dept_selesai => {
                                            if (dept_selesai.pic == dept.pic) {
                                                array_per_dept[(dept.pic+"_"+"selesai").replace(/\s/g, '')]=dept_selesai.count_selesai_dept_task;
                                            }else{
                                                // array_per_dept[(dept.pic+"_"+"selesai").replace(/\s/g, '')]=0;
                                            }   
                                        });
                                        console.log(array_per_dept);
                                ...
                                // count delay persen ke diagram all
